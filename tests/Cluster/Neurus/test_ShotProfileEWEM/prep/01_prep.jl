...
SegyToSeis("/u4/data/synthetic/kevins_model/elastic/vp_mig.rsf","vp",["format"=>"rsf"]);
SegyToSeis("/u4/data/synthetic/kevins_model/elastic/vs_mig.rsf","vs",["format"=>"rsf"]);
SegyToSeis("/u4/data/synthetic/kevins_model/elastic/vp_mig_raw.rsf","vp_raw",["format"=>"rsf"]);
SegyToSeis("/u4/data/synthetic/kevins_model/elastic/vs_mig_raw.rsf","vs_raw",["format"=>"rsf"]);
...
SegyToSeis("/u4/data/synthetic/kevins_model/elastic/dx.rsf","ux_raw1",["format"=>"rsf"]);
SegyToSeis("/u4/data/synthetic/kevins_model/elastic/dz.rsf","uz_raw1",["format"=>"rsf"]);
SeisWriteHeaders("ux_raw1",h_d)
SeisWriteHeaders("uz_raw1",h_d)

# set up headers in wavelet file
SegyToSeis("/u4/data/synthetic/kevins_model/elastic/wav_resample.rsf","wav",["format"=>"rsf"]);
h_w = Header[]
...
SeisWindow("ux_raw2","ux_raw3",["isx" "hx" "gx" "gy"],[0 -3304.0 0.0 0.0],[68 3304.0 6992.0 0.0])
...
coh,pp_slope,res = SeisPWD(vp_raw,["w1"=>30,"w2"=>30,"dx"=>8,"dz"=>4,"format"=>"dip"]);
SeisWrite("dipx_slope",pp_slope,h);
SeisWrite("dipy_slope",pp_slope*0,h);

SeisWindow("ux","ux_1shot",["isx"],[35],[35])
SeisWindow("uy","uy_1shot",["isx"],[35],[35])
