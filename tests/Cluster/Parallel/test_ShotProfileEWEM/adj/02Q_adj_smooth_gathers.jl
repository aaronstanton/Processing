...
SeisWindow("mpp_smooth2","mpp_gather1",{"key"=>["imx"],"minval"=>[200]})
SeisWindow("mps2_smooth2","mps2_gather1",{"key"=>["imx"],"minval"=>[200]})
SeisWindow("mpp_smooth2","mpp_gather2",{"key"=>["imx"],"minval"=>[300]})
SeisWindow("mps2_smooth2","mps2_gather2",{"key"=>["imx"],"minval"=>[300]})
SeisWindow("mpp_smooth2","mpp_gather3",{"key"=>["imx"],"minval"=>[400]})
SeisWindow("mps2_smooth2","mps2_gather3",{"key"=>["imx"],"minval"=>[400]})
SeisWindow("mpp_smooth2","mpp_gather4",{"key"=>["imx"],"minval"=>[500]})
SeisWindow("mps2_smooth2","mps2_gather4",{"key"=>["imx"],"minval"=>[500]})
SeisWindow("mpp_smooth2","mpp_gather5",{"key"=>["imx"],"minval"=>[600]})
SeisWindow("mps2_smooth2","mps2_gather5",{"key"=>["imx"],"minval"=>[600]})
