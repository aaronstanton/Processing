...
# read velocity files
SegyToSeis("/global/scratch/stanton/kevins_model/elastic/vp_mig.rsf","vp","rsf");
vp,h_v = SeisRead("vp");
vp = reshape(vp,nz,nmx,nmy);

SegyToSeis("/global/scratch/stanton/kevins_model/elastic/vs_mig.rsf","vs","rsf");
vs,h_v = SeisRead("vs");
...
# read velocity files
SegyToSeis("/global/scratch/stanton/kevins_model/elastic/vp_mig_raw.rsf","vp_raw","rsf");
...
# read a data files
SegyToSeis("/global/scratch/stanton/kevins_model/elastic/dz.rsf","uz","rsf");
uz,h_d = SeisRead("uz");
...
SegyToSeis("/global/scratch/stanton/kevins_model/elastic/wav_resample.rsf","wav","rsf");
w,h_w = SeisRead("wav");
